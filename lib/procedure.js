...
function runCommand(inputPath, outputPath, outputFormat, argString, callback) {
    var files, command, i;
    if (typeof callback == 'undefined')
        callback = catchWarning;
...
function procedure(callback) {
    ...
    return runCommand(inputPath, args['-o'][0], outputFormat, argString, callback);
}

module.exports = {
    "init": function (rawArguments, parsedArguments, callback) {
